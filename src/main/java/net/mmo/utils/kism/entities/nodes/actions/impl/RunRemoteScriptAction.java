...
@ToString
@Slf4j
public class RunRemoteScriptAction <N extends ActionableNode> implements IAction<N>
{
	private static final long serialVersionUID = 3910888891357252368L;
	...
	public void doAction(N node, State oldState, State newState) {
		...
		log.info("run remote script here... {}", test); //$NON-NLS-1$
//		if (newState == FAILED) {
//			restartSystem();
//		}
	}
